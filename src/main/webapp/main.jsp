		...
		<div class="container">
			...
			<div class="navbar_div  ">
				...
				<div class="a_group agroup  col-md-12">
					<a class="register_a " href="register">
				...
				<div class="a_group bgroup col-md-12" >
					...
					<a class="sharepic_a " href="userinfo.html">
						<i class="fa fa-share-alt fa-fw"></i> 发图
					</a>
			...
			<div id="" class="search_row row">
				...
				<div class="col-md-4">
					<div class="input_div form-inline">
						<input type="text" placeholder="搜索" class="form-control col-md-11 search_input" />
			...
			<div id="content_div">
				...
				<div class="row content_row">
					...
					<div class="col-md-4 card_div">
						<div class="img_div">
							<img data-imgid="bsc" class="card-img-top simple_img" src="static/img/无标题.png">
						</div>
						<div class="card-body">
